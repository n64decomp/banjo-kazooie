...
ActorInfo D_803907F4 = {
    MARKER_18E_RBB_SPINNING_SINGLE_PIPE_2, ACTOR_17E_RBB_SPINNING_SINGLE_PIPE_2, ASSET_406_MODEL_RBB_SPINNING_SINGLE_PIPE, 0x0, NULL,
    func_8038A724, NULL, actor_draw,
    0, 0, 0.0f, 0
};

ActorInfo D_80390818 = {
    MARKER_18F_RBB_SPINNING_DOUBLE_PIPE_1, ACTOR_17F_RBB_SPINNING_DOUBLE_PIPE_1, ASSET_407_MODEL_RBB_SPINNING_DOUBLEE_PIPE_RIGHT, 0x0, NULL,
    func_8038A724, NULL, actor_draw,
    0, 0, 0.0f, 0
};

ActorInfo D_8039083C = {
    MARKER_190_RBB_SPINNING_DOUBLE_PIPE_2, ACTOR_180_RBB_SPINNING_DOUBLE_PIPE_2, ASSET_408_MODEL_RBB_SPINNING_DOUBLEE_PIPE_LEFT, 0x0, NULL,
    func_8038A724, NULL, actor_draw,
    0, 0, 0.0f, 0
};
