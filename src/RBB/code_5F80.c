...
void func_8038C39C(Actor *this){
    ...
    func_802EF5C8(other, local->unk0->unkE);
}
...
void func_8038C538(Actor *this){
    ...
    func_802EF5C8(other, 3*local->unk0->unkE);
...
void func_8038C70C(Actor *this){
    ...
    func_802EFC84(other, &D_80390C6C);
    func_802EF5C8(other, 10);
...
void func_8038CC9C(Actor *this, s32 new_state){
    ...
    if(this->state == 2){
        ...
        func_80324C88(0.5f, 0x3f5, 1.0f, 0x7fc6);
        func_80324C88(1.25f, 0x6C, 1.05f, 0x7d00);
        func_80324C88(1.35f, 0x6C, 1.0f, 0x7d00);
        func_80324C88(1.8f, 0x6C, 1.0f, 0x7d00);
        if(func_803203FC(2)){
            func_80346414(6, 1);
            func_80346414(0, 0x1067);
            func_80324E88(2.4f);
    ...
    if(this->state == 5){
        ...
        func_80324C88(0.2f, 0xd9, 0.9f, 0x7530);
