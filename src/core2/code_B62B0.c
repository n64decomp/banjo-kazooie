...
CollisionTable collision_table[COLLISION_TABLE_SIZE] = {
    ...
    {MARKER_25E_GRUNTILDA_FINAL_BOSS,              0x0000, {0x4000, 0x4000, 0x4000, 0xA604, 0x4000, 0x4000, 0x4000, 0x0584, 0xA000, 0x0000, 0x4000}},
...
s32 collision_getSoundEffect(CollisionParams *arg0){
    return arg0->soundEffect;
}
