        ...
        if(func_8028A41C(183.0f, -100.0f, 75.0f)){
            if(func_802DE41C() == 6){
                if(!D_8037DCCC){
                    ...
                    func_80311480(0xe33, 0x6, &D_80363610, 0, func_8028A584, 0);
                }
            }//L8028A70C
            else if(func_802DE41C() == 7){
                func_8028F94C(4, &D_80363610);
                func_80311480(0xe35, 0x6, &D_80363610, 0, func_8028A558, 0);
                D_8037DCCC = 1;
            }//L8028A764
                ...
                if( (((D_8036361C[0] <= sp30[0])? (sp30[0] - D_8036361C[0]) : -(sp30[0] - D_8036361C[0])) < 4.0f)
                    ...
                    if(!D_8037DCCA){
                        func_8028F94C(4, &D_80363610);
                        func_80311480(0xe21, 6, &D_80363610, 0, func_8028A584, 0);
                        D_8037DCCA = 1;
                    }else{
                        func_8028A584(0,0,0);
                    }
                ...
                if(!D_8037DCCB){
                    func_8028F94C(4, &D_80363610);
                    func_80311480(0xe20, 6, &D_80363610, 0, func_8028A558, 0);
                    D_8037DCCB = 1;
                }
            }
        }
