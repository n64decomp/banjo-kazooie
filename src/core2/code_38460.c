...
/* .rodata */
extern f32 D_80375F00;

/* .bss */
extern f32 D_8037DAB0[3];
extern f32 D_8037DABC;
...
void func_802BF454(void) {
    ...
    sp30 = ml_map_f(D_8037DABC, D_80375F00, 0.5f, gu_sqrtf(sp5C[0] * sp5C[0] + sp5C[1] * sp5C[1] + sp5C[2] * sp5C[2]), 300.0f);
