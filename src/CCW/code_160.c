...
void func_8038687C(Actor *this) {
    ...
    if (func_8025773C(&local->unkC, sp88)) {
        if ((local->unk4 < 3) && ((local->unk8 + local->unk4) < 10)) {
            ...
            for(phi_s0 = 0; phi_s0 < 20; phi_s0++){
                ...
                if(func_80256064(this->position, sp4C) < 400.0f)
                    continue;
                
                tmp = func_80256064(sp5C, sp4C);
    ...
    if (this->state == 1) {
        if (func_803203FC(2) && func_803203FC(3)) {
            ...
            if ((func_80256064(this->position, sp40) < 300.0f) && (player_getTransformation() == TRANSFORM_1_BANJO)) {
