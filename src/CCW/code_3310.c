...
extern ActorInfo D_8038F130 = { 0x1B4, 0x2A1, 0x484, 0x0, NULL, func_80389BFC, NULL, func_80389B24, { 0x0, 0x0}, 0, 0.0f, { 0x0, 0x0, 0x0, 0x0}};
...
void func_80389BFC(Actor *this) {
    ...
    if (this->state == 1) {
        ...
        if ((local->unk0->map_id != MAP_43_CCW_SPRING) && ((this->position[0] + 500.0f) < sp4C[0])) {
            func_8028F364(this->position, 1110.0f, 200.0f, 0x2A2, &this);
            if ((local->unk0->unkE != 0) && (func_8028E8C0() == 0x2A2) && (func_80256064(this->position, sp4C) < 1010.0f) && (func_8028FC34() != 0)) {
