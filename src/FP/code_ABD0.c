...
extern ActorInfo gXmasTreeSwitch;
extern ActorInfo gXmasTreeStar;
...
void FP_func_80391324(void)
{
      ...
      spawnableActorList_add(&gXmasTreeSwitch, actor_new, ACTOR_FLAG_UNKNOWN_2);
      spawnableActorList_add(&gXmasTreeStar, actor_new, ACTOR_FLAG_UNKNOWN_2 | ACTOR_FLAG_UNKNOWN_6 | ACTOR_FLAG_UNKNOWN_10);
      ...
      spawnableActorList_add(&gXmasTreeIce, actor_new, ACTOR_FLAG_UNKNOWN_17);
