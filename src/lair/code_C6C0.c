...
/* .data */
ActorInfo D_80394D20 = { 0x29C, 0x3C9, 0x0, 0x0, NULL, func_80392B6C, func_80326224, func_80325340, { 0x0, 0x0}, 0, 0.0f, { 0x0, 0x0, 0x0, 0x0}};
...
void func_80392B6C(Actor *this) {
    ...
    if (mapSpecificFlags_get(7) != 0) {
        sp28 = func_80256064(this->position, this->unk1C) / 350.0;
