...
ActorInfo D_803931EC = {
    0x116, 0x21A, 0x4AC,
    0x1, NULL, func_803893B8, actor_update_func_80326224, actor_drawFullDepth,
    0, 0, 0.0f, 0x82
};

ActorInfo D_80393210 = {
    0x117, 0x21B, 0x4AD,
    0x1, NULL, lair_func_803894B0, actor_update_func_80326224, actor_drawFullDepth,
    0, 0, 0.0f, 0x82
};

ActorInfo D_80393234 = {
    0x10B, 0x20F, 0x4B4,
    0x1, NULL, func_80388524, actor_update_func_80326224, actor_drawFullDepth,
    0, 0, 0.0f, 0x90
};
...
ActorInfo D_803932C4 = {
    0x122, ACTOR_228_MMM_ENTRANCE_DOOR,
    0x4BE, 0x1, NULL, func_80388524, actor_update_func_80326224, actor_drawFullDepth,
    0, 0, 0.0f, 0x8C
};

ActorInfo D_803932E8 = {
    0x10F, 0x213,
    0x4A8, 0x1, NULL, func_803875F0, actor_update_func_80326224, actor_drawFullDepth,
    0, 0, 0.0f, 0x80
};

ActorInfo D_8039330C = {
    0x118, 0x21E, 0x4B1,
    0x1, NULL, lair_func_8038A084, actor_update_func_80326224, actor_drawFullDepth,
    0, 0, 0.0f, 0x8F
};

ActorInfo D_80393330 = {
    0x119, 0x21F, 0x4B6,
    0x1, NULL, func_8038A0A4, actor_update_func_80326224, actor_drawFullDepth,
    0, 0, 0.0f, 0x92
};

ActorInfo D_80393354 = {
    0x266, 0x2E3, 0x563,
    0x1, NULL, func_803870DC, actor_update_func_80326224, lair_func_80387560,
    0, 0, 0.0f, 0
};

ActorInfo D_80393378 = {
    0x17D, 0x1E1, 0x517,
    0x1, NULL, func_80389D08, actor_update_func_80326224, func_80389E10,
    0, 0, 0.0f, 0x8D
};

ActorInfo D_8039339C = {
    0x234, 0x23E, 0x4E1,
    0x12, D_80392CB0, func_8038982C, actor_update_func_80326224, actor_drawFullDepth,
    0, 0, 0.0f, 0
};

ActorInfo D_803933C0 = {
    0x163, 0x258, ASSET_511_MODEL_CRYPT_COFFIN_LID,
    0x12, D_80392CB0, func_80389898, actor_update_func_80326224, func_8038664C,
    0, 0, 0.0f, 0x8E
};

ActorInfo D_803933E4 = {
    0x160, 0x255, ASSET_509_MODEL_SARCOPHAGUS,
    0x15, D_80392CB0, func_80389934, actor_update_func_80326224, actor_draw,
    0, 0, 0.0f, 0
};

ActorInfo D_80393408 = {
    0x102, 0x203, 0x491,
    0x1, D_80392CB0, func_80387730, actor_update_func_80326224, func_80387DA8,
    0, 0, 0.0f, 0
};
