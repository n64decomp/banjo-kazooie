...
enum bkprog_e{
    ...
    BKPROG_11_HAS_MET_MUMBO = 0x11,
    BKPROG_12_HAS_TRANSFORMED_BEFORE = 0x12,
    BKPROG_13_XMAS_UNKNOWN = 0x13, //something with xmas tree jiggy progress
    BKPROG_14_HAS_TOUCHED_FP_ICY_WATER = 0x14,
    ...
    BKPROG_36_GV_OPEN,
    BKPROG_37_MMM_OPEN,
    BKPROG_38_RBB_OPEN = 0x38,
    BKPROG_39_CCW_OPEN = 0x39,
    ...
    BKPROG_46_CCW_WITCH_SWITCH_JIGGY_SPAWNED = 0x46,
    BKPROG_47_UNKNOWN = 0x47,
    ...
    BKPROG_84_MAGIC_ALL_GONE_TEXT = 0x84,
    ...
    BKPROG_CE_GRATE_TO_MMM_PUZZLE_OPEN = 0xce,
...
enum unkflags_1{
    ...
    UNKFLAGS1_74_SANDCASTLE_INFINITE_EGGS = 0x74,
    ...
    UNKFLAGS1_88_UNKNOWN = 0X88,
    UNKFLAGS1_89_UNKNOWN = 0X89,
    ...
    UNKFLAGS1_90_SANDCASTLE_OPEN_RBB = 0X90,
    UNKFLAGS1_91_UNKNOWN = 0X91,
    UNKFLAGS1_92_UNKNOWN = 0X92,
...
enum level_flags_e
{
    LEVEL_FLAG_0_CC_TOKEN_TOOTH_OPEN = 0x0,
    LEVEL_FLAG_1_CC_JIGGY_TOOTH_OPEN = 0x1
};

enum transformation_e
{
    TRANSFORM_0_UNKNOWN = 0x0,
    TRANSFORM_1_BANJO = 0x1,
    TRANSFORM_2_TERMITE = 0x2,
    TRANSFORM_3_PUMPKIN  = 0x3,
    TRANSFORM_4_WALRUS = 0x4,
    TRANSFORM_5_CROC = 0x5,
    TRANSFORM_6_BEE = 0x6,
    TRANSFORM_7_WISHWASHY = 0x7
};
...
enum map_e
{
    ...
    MAP_36_RBB_BOATHOUSE = 0x36,
    MAP_37_RBB_CONTAINER_1 = 0x37,
...
enum comusic_e
{
    ...
    COMUSIC_28_CCW_SUMMER,
    COMUSIC_28_CCW_WINTER,
    COMUSIC_2B_DING_B,
    COMUSIC_2C_BUZZER,
...
{
    SFX_0_BLOOP = 0x0000,
    SFX_1_MUMBO_OOMENAKA = 0x0001,
    SFX_2_CLAW_SWIPE = 0x0002,
    SFX_3_DULL_CANNON_SHOT = 0x0003,
    // Long Beakbarge 2nd Part
    SFX_4_KAZOOIE_RUUUUUH = 0x0004,
    SFX_5_BANJO_LANDING_01 = 0x0005,
    SFX_6_BANJO_LANDING_02 = 0x0006,
    SFX_7_BANJO_LANDING_03 = 0x0007,
    SFX_8_BANJO_LANDING_04 = 0x0008,
    SFX_9_SQUEAKY_TOY = 0x0009,
    SFX_A_BANJO_LANDING_05 = 0x000A,
    SFX_B_BANJO_LANDING_06 = 0x000B,
    SFX_C_TAKING_FLIGHT_LIFTOFF = 0x000C,
    SFX_D_EGGSHELL_BREAKING = 0x000D,
    SFX_E_SHOCKSPRING_BOING = 0x000E,
    SFX_F_SMALL_WATER_SPLASH = 0x000F,
    // shallow water
    SFX_10_BANJO_LANDING_07 = 0x0010,
    // Blubber's Ship's Trapdoor eg.
    SFX_11_WOOD_BREAKING_1 = 0x0011,
    SFX_12_WATER_PADDLING_1 = 0x0012,
    SFX_13_BEAKBUSTER_GROUND = 0x0013,
    // sounds like a muffled frying pan
    SFX_14_METALLIC_HIT_1 = 0x0014,
    // less frying pan-ish
    SFX_15_METALLIC_HIT_2 = 0x0015,
    // In the Opening Musical, when Mumbo's Xylophone drops
    SFX_16_HEAVY_FALL_VIBRATO = 0x0016,
    SFX_17_JINJO_WHISTLE = 0x0017,
    SFX_18_BIGBUTT_SLIDE = 0x0018,
    SFX_19_BANJO_LANDING_08 = 0x0019,
    SFX_1A_BIG_THINGS_FALL_OVER = 0x001A,
    // from the sea-mines
    SFX_1B_EXPLOSION_1 = 0x001B,
    SFX_1C_ALARMCLOCK = 0x001C,
    // hitting the Bull eg.
    SFX_1D_HITTING_AN_ENEMY_1 = 0x001D,
    // might also be used for breaking boulders
    SFX_1E_HITTING_AN_ENEMY_2 = 0x001E,
    // hitting a Gruntling eg.
    SFX_1F_HITTING_AN_ENEMY_3 = 0x001F,
    ...
    SFX_12F_THAAANKY_YOUUU,
    SFX_130_GRUNTY_ECHOING_CRY = 0x0130, // from her final fall
    ...
    SFX_3EA_UNKNOWN = 0x3EA,  //chjig
    SFX_3EB_UNKNOWN = 0x3EB,  //bstimeout
    SFX_3EC_CCW_DOOR_OPENING_UNKNOWN = 0x3EC,        //ccw and GV opening
    SFX_3ED_UNKNOWN = 0x3ED,
    SFX_3EE_UNKNOWN = 0x3EE,
    SFX_3EF_UNKNOWN = 0x3EF,
...
enum level_e
{
    ...
    LEVEL_2_TREASURE_TROVE_COVE = 0x2,
    LEVEL_3_CLANKERS_CAVERN = 0x3,
    LEVEL_4_BUBBLEGLOOP_SWAMP = 0x4,
    LEVEL_5_FREEZEEZY_PEAK = 0x5,
    LEVEL_6_LAIR = 0x6,
    LEVEL_7_GOBIS_VALLEY = 0x7,
    LEVEL_8_CLICK_CLOCK_WOOD = 0x8,
    LEVEL_9_RUSTY_BUCKET_BAY = 0x9,
    LEVEL_A_MAD_MONSTER_MANSION = 0xA,
...
enum honeycomb_e
{
    HONEYCOMB_0_UNKNOWN = 0x00,
    HONEYCOMB_1_MM_HILL = 0x01,
    HONEYCOMB_2_MM_JUJU = 0x02,
...
enum actor_e
{
    ...
    ACTOR_40_CLANKER_SAWBLADE_PROPELLOR_4 = 0x40,
    ACTOR_41_CLANKER_SAWBLADE_PROPELLOR_5 = 0x41,
    ACTOR_42_CLANKER_SAWBLADE_PROPELLOR_6 = 0x42,
    ACTOR_43_UNKNOWN = 0x43,
    ACTOR_44_CLANKER_TOKEN_TOOTH_EXTERIOR = 0x44,
    ACTOR_45_CLANKER_JIGGY_TOOTH_EXTERIOR = 0x45,
    ACTOR_46_JIGGY = 0x46,
    ACTOR_47_EMPTY_HONEYCOMB = 0x47,
    ACTOR_48_UNKNOWN = 0x48,
    ACTOR_49_EXTRA_LIFE = 0x49,
    ACTOR_4A_WOOD_EXPLOSION = 0x4A,
    ACTOR_4B_UNKNOWN = 0x4B,
    ACTOR_4C_STEAM = 0x4C,
    ACTOR_4D_STEAM_2 = 0x4D,
    ACTOR_4E_UNKNOWN = 0x4E,
    ACTOR_4F_UNKNOWN = 0x4F,
    ...
    ACTOR_6E_UNKNOWN = 0x6E,    
    ACTOR_6F_UNKNOWN = 0x6F,    
    ACTOR_70_UNKNOWN = 0x70,
    ACTOR_71_UNKNOWN = 0x71,
    ACTOR_72_UNKNOWN = 0x72,
    ACTOR_73_UNKNOWN = 0x73,
    ACTOR_74_UNKNOWN = 0x74,
    ACTOR_75_UNKNOWN = 0x75,
    ACTOR_76_UNKNOWN = 0x76,
    ACTOR_77_UNKNOWN = 0x77,
    ACTOR_78_UNKNOWN = 0x78,
    ACTOR_79_UNKNOWN = 0x79,
    ACTOR_7A_UNKNOWN = 0x7A,
    ACTOR_7B_UNKNOWN = 0x7B,
    ACTOR_7C_UNKNOWN = 0x7C,
    ACTOR_7D_UNKNOWN = 0x7D,
    ACTOR_7E_UNKNOWN = 0x7E,
    ACTOR_7F_UNKNOWN = 0x7F,
    ACTOR_80_UNKNOWN = 0x80,
    ACTOR_81_UNKNOWN = 0x81,
    ACTOR_82_UNKNOWN = 0x82,
    ACTOR_83_UNKNOWN = 0x83,
    ACTOR_84_UNKNOWN = 0x84,
    ACTOR_85_UNKNOWN = 0x85,
    ACTOR_86_UNKNOWN = 0x86,
    ACTOR_87_UNKNOWN = 0x87,
    ACTOR_88_UNKNOWN = 0x88,
    ACTOR_89_UNKNOWN = 0x89,
    ACTOR_8A_UNKNOWN = 0x8A,
    ACTOR_8B_UNKNOWN = 0x8B,
    ACTOR_8C_UNKNOWN = 0x8C,
    ACTOR_8D_UNKNOWN = 0x8D,
    ACTOR_8E_UNKNOWN = 0x8E,
    ACTOR_8F_UNKNOWN = 0x8F,
    ACTOR_90_UNKNOWN = 0x90,
    ACTOR_91_UNKNOWN = 0x91,
    ACTOR_92_UNKNOWN = 0x92,
    ACTOR_93_UNKNOWN = 0x93,
    ACTOR_94_UNKNOWN = 0x94,
    ACTOR_95_UNKNOWN = 0x95,
    ACTOR_96_UNKNOWN = 0x96,
    ACTOR_97_UNKNOWN = 0x97,
    ACTOR_98_UNKNOWN = 0x98,
    ACTOR_99_UNKNOWN = 0x99,
    ACTOR_9A_UNKNOWN = 0x9A,
    ACTOR_9B_UNKNOWN = 0x9B,
    ACTOR_9C_UNKNOWN = 0x9C,
    ACTOR_9D_UNKNOWN = 0x9D,
    ACTOR_9E_UNKNOWN = 0x9E,
    ACTOR_9F_UNKNOWN = 0x9F,
    ACTOR_A0_UNKNOWN = 0xA0,
    ACTOR_A1_UNKNOWN = 0xA1,
    ACTOR_A2_UNKNOWN = 0xA2,
    ACTOR_A3_UNKNOWN = 0xA3,
    ACTOR_A4_UNKNOWN = 0xA4,
    ACTOR_A5_UNKNOWN = 0xA5,
    ACTOR_A6_UNKNOWN = 0xA6,
    ACTOR_A7_UNKNOWN = 0xA7,
    ACTOR_A8_UNKNOWN = 0xA8,
    ACTOR_A9_UNKNOWN = 0xA9,
    ACTOR_AA_UNKNOWN = 0xAA,
    ACTOR_AB_UNKNOWN = 0xAB,
    ACTOR_AC_UNKNOWN = 0xAC,
    ACTOR_AD_UNKNOWN = 0xAD,
    ACTOR_AE_UNKNOWN = 0xAE,
    ACTOR_AF_UNKNOWN = 0xAF,
    ACTOR_B0_UNKNOWN = 0xB0,
    ACTOR_B1_UNKNOWN = 0xB1,
    ACTOR_B2_UNKNOWN = 0xB2,
    ACTOR_B3_UNKNOWN = 0xB3,
    ACTOR_B4_UNKNOWN = 0xB4,
    ACTOR_B5_UNKNOWN = 0xB5,
    ACTOR_B6_UNKNOWN = 0xB6,
    ACTOR_B7_UNKNOWN = 0xB7,
    ACTOR_B8_UNKNOWN = 0xB8,
    ACTOR_B9_UNKNOWN = 0xB9,
    ACTOR_BA_UNKNOWN = 0xBA,
    ACTOR_BB_UNKNOWN = 0xBB,
    ACTOR_BC_UNKNOWN = 0xBC,
    ACTOR_BD_UNKNOWN = 0xBD,
    ACTOR_BE_UNKNOWN = 0xBE,
    ACTOR_BF_UNKNOWN = 0xBF,
    ACTOR_C0_UNKNOWN = 0xC0,
    ACTOR_C1_UNKNOWN = 0xC1,
    ACTOR_C2_UNKNOWN = 0xC2,
    ACTOR_C3_UNKNOWN = 0xC3,
    ACTOR_C4_UNKNOWN = 0xC4,
    ACTOR_C5_CHIMPY_STUMP = 0xC5,
    ACTOR_C6_UNKNOWN = 0xC6,     
    ACTOR_C7_UNKNOWN = 0xC7,
    ACTOR_C8_BOGGY_2 = 0xC8,
    ACTOR_C9_UNKNOWN = 0xC9,
    ACTOR_CA_TEEHEE = 0xCA,
    ACTOR_C9_UNKNOWN = 0xCB,
    ACTOR_C9_UNKNOWN = 0xCD,
    ACTOR_E4_FLIGHT_PAD = 0xE4,
    ACTOR_E5_UNKNOWN = 0xE5,
    ACTOR_E6_GLOOP = 0xE6,
    ACTOR_E7_GLOOP_BUBBLE = 0xE7,

    ACTOR_F1_LEAFBOAT = 0xF1,
    ...
    ACTOR_135_GOBI_3 = 0x135,
    ACTOR_136_YELLOW_FLIBBIT_CONTROLLER,

    ACTOR_139_yumblie           = 0x139,
    ...
    ACTOR_211_TTC_ENTRANCE,
    ACTOR_212_CC ENTRANCE,
    ...
    ACTOR_291_CLANKER_SAWBLADE_PROPELLOR_8 = 0x291,
    ACTOR_292_CLANKER_SAWBLADE_PROPELLOR_9 = 0x292,
    ACTOR_293_CLANKER_SAWBLADE_PROPELLOR_10 = 0x293,
    ACTOR_294_CLANKER_SAWBLADE_PROPELLOR_11 = 0x294,
    ACTOR_295_CLANKER_SAWBLADE_PROPELLOR_12 = 0x295,
...
enum item_e
{
    ITEM_0_HOURGLASS_TIMER = 0x00,
    ITEM_1_SKULL_HOURGLASS_TIMER,

    ITEM_3_PROPELLOR_TIMER = 0x03,

    ITEM_5_XMAS_TREE_TIMER = 0x05,
    ITEM_6_HOURGLASS,
    ITEM_7_SKULL_HOURGLASS,


    ITEM_9_PROPELLOR = 0x09,

    ITEM_B_XMAS_TREE = 0x0B,
    ITEM_C_NOTE = 0x0C,
    ITEM_D_EGGS,
    ITEM_E_JIGGY,
    ITEM_F_RED_FEATHER,
...
enum game_mode_e
{
    GAME_MODE_0_UNKNOWN = 0x0,
    GAME_MODE_1_UNKNOWN = 0x1,
    GAME_MODE_2_UNKNOWN = 0x2,
    GAME_MODE_3_NORMAL = 0x3,
    GAME_MODE_4_PAUSED = 0x4,
    GAME_MODE_6_FILE_PLAYBACK = 0x6,
    GAME_MODE_7_ATTRACT_DEMO = 0x7,
    GAME_MODE_8_BOTTLES_BONUS = 0x8,
    GAME_MODE_9_BANJO_AND_KAZOOIE = 0x9,
    GAME_MODE_A_SNS_PICTURE = 0xA
};
...
enum asset_e
{
    ...
    ASSET_E6_ANIM_SLAPPA_IDLE = 0xE6,
    ASSET_E7_ANIM_SLAPPA_HIDE = 0xE7,
    ASSET_E8_ANIM_SLAPPA_DIE = 0xE8,
    ASSET_E9_UNKNOWN = 0xE9,
    ASSET_EA_UNKNOWN = 0xEA,
    ASSET_EB_UNKNOWN = 0xEB,
    ASSET_EC_UNKNOWN = 0xEC,
    ...
    ASSET_565_Bottles_Game_Banjo_Hand = 0x564,
    // 566 Black Snippet
    ...
    // Unused
    // Unused
    ASSET_6B0_UNKNOWN = 0x6B0,
    ASSET_6B1_SPRITE_WEED = 0x6B1,
    ASSET_6C2_SPRITE_PURPLE_WEED = 0x6B2,
    ASSET_6C3_SPRITE_WHITE_WEED = 0x6B3,
    ASSET_6C4_UNKNOWN = 0x6B4,
    ASSET_6C5_UNKNOWN = 0x6B5,
    ASSET_6C6_SPRITE_SMOKE_PINK = 0x6B6,
    ASSET_6C7_SPRITE_FIRE = 0x6B7,
    ASSET_6B8_UNKNOWN = 0x6B8,
    ASSET_6B9_UNKNOWN = 0x6B9,
    ASSET_6BA_UNKNOWN = 0x6BA,
    ASSET_6BB_UNKNOWN = 0x6BB,
    ASSET_6BC_UNKNOWN = 0x6BC,
    ASSET_6BD_UNKNOWN = 0x6BD,
    ASSET_6BE_UNKNOWN = 0x6BE,
    ASSET_6BF_UNKNOWN = 0x6BF,
    ASSET_6C0_UNKNOWN = 0x6B0,
    ...
    ASSET_6C7_SPRITE_SMOKE_GREEN_2 = 0x6C7,
    ASSET_6C8_SPRITE_SMOKE_BLUE = 0x6C8,
    ASSET_6C9_SPRITE_SMOKE_GREEN_BIG = 0x6C9,
    ASSET_6CA_UNKNOWN = 0x6CA,
    ASSET_6CB_UNKNOWN = 0x6CB,
    ASSET_6CC_UNKNOWN = 0x6CC,
    ASSET_6CD_UNKNOWN = 0x6CD,
    ASSET_6CE_UNKNOWN = 0x6CE,
    ASSET_6CF_UNKNOWN = 0x6CF,
    ASSET_6D0_UNKNOWN = 0x6D0,
    ...
    ASSET_A70_TEXT_CHARMER_HELPED = 0xA70,
    ASSET_A71_TEXT_TRUNKER_MEET = 0xA71,
    ASSET_A72_TEXT_TRUNKER_HELPED = 0xA72,
    ASSET_A73_TEXT_GOBI_MEET = 0xA73,
    ASSET_A74_TEXT_GOBI_HELPED = 0xA74,
    ASSET_A75_TEXT_GOBI2_MEET = 0xA75,
    ASSET_A76_TEXT_GOBI2_DONE = 0xA76,
    ASSET_A77_TEXT_GOBI3_DONE = 0xA77,
    ASSET_A78_TEXT_GRABBA_MEET = 0xA78,
    ASSET_A79_TEXT_GRABBA_DEFEAT = 0xA79,
    ASSET_A7A_TEXT_GRABBA_TOO_FAST = 0xA7A,
    ASSET_A7B_TEXT_JINXY_MEET = 0xA7B,
    ASSET_A7C_TEXT_JINXY_ONE_EGG = 0xA7C,
    ASSET_A7D_TEXT_JINXY_HELPED = 0xA7D,
    ASSET_A7E_TEXT_SAND_EELS_MEET = 0xA7E,
    ASSET_A7F_TEXT_ANICIENT_ONES_MEET = 0xA7F,
    ASSET_A80_TEXT_ANICIENT_ONES_DONE = 0xA80,
    ASSET_A81_TEXT_SANDYBUTT_ENTER = 0xA81,
    ASSET_A82_TEXT_SANDYBUTT_START_MAZE = 0xA82,
    ASSET_A83_TEXT_SANDYBUTT_DONE = 0xA83,
    ASSET_A84_UNKNOWN = 0xA84,
    ASSET_A85_UNKNOWN = 0xA85,
    ASSET_A86_UNKNOWN = 0xA86,
    ASSET_A87_UNKNOWN = 0xA87,
    ASSET_A88_UNKNOWN = 0xA88,
    ASSET_A89_UNKNOWN = 0xA89,
    ASSET_A8A_UNKNOWN = 0xA8A,
    ASSET_A8B_UNKNOWN = 0xA8B,
    ASSET_A8C_UNKNOWN = 0xA8C,
    ASSET_A8D_UNKNOWN = 0xA8D,
    ASSET_A8E_UNKNOWN = 0xA8E,
    ASSET_A8F_UNKNOWN = 0xA8F,
    ASSET_A90_UNKNOWN = 0xA90,
    ASSET_A91_UNKNOWN = 0xA91,
    ASSET_A92_UNKNOWN = 0xA92,
    ASSET_A93_UNKNOWN = 0xA93,


    ASSET_ADE_TEXT_LOGGO_AS_BEAR = 0xADE,
    ASSET_ADF_TEXT_ENTER_LOGGO = 0xADF,
    ASSET_AE0_TEXT_EXIT_LOGGO = 0xAE0,
...
enum marker_e{
    ...
    MARKER_49_MOTZHAND = 0x49,
    MARKER_4A_UNKNOWN = 0x4A,
    MARKER_4B_UNKNOWN = 0x4B,
    MARKER_4C_CLANKER_TOKEN_TOOTH_EXT = 0x4C,
    MARKER_4D_CLANKER_JIGGY_TOOTH_EXT = 0x4D,
    MARKER_4E_UNKNOWN = 0x4E,
    MARKER_4F_UNKNOWN = 0x4F,
    ...
    MARKER_F8_GV_KAZOOIE_DOOR = 0xF8,
    MARKER_F9_JINXY,
    ...
    MARKER_1FA_POLAR_BEAR_CUB_BLUE = 0x1FA,
    ...
    MARKER_254_PORTRAIT_CHOMPA = 0x254,
    MARKER_255_PORTRAIT_OF_GRUNTY,

    MARKER_257_PORTRAIT_OF_BLACKEYE = 0x257,
...
enum common_particle_e{
    COMMON_PARTICLE_1_EGG_HEAD = 0x1,
    COMMON_PARTICLE_4_EGG_ASS = 0x4
};

enum bsgroup_e {
    BSGROUP_2_WONDERWING = 0x2,
...
enum bswatergroup_e{
    BSWATERGROUP_0_NONE = 0x01,
    BSWATERGROUP_1_SURFACE = 0x02,
    BSWATERGROUP_2_UNDERWATER = 0x03
};

enum misc_flag_e{
    MISC_FLAG_1_ON_FLIGHT_PAD = 0x01,
    MISC_FLAG_2_ON_SPRING_PAD = 0x02,
    MISC_FLAG_3_UNKNOWN = 0x03,
    MISC_FLAG_4_UNKNOWN = 0x04,
    MISC_FLAG_5_UNKNOWN = 0x05,
    MISC_FLAG_6_UNKNOWN = 0x06,
    MISC_FLAG_7_UNKNOWN = 0x07,
    MISC_FLAG_8_UNKNOWN = 0x08,
    MISC_FLAG_9_UNKNOWN = 0x09,
    MISC_FLAG_A_UNKNOWN = 0x0A,
    MISC_FLAG_B_UNKNOWN = 0x0B,
    MISC_FLAG_C_UNKNOWN = 0x0C,
    MISC_FLAG_D_UNKNOWN = 0x0D,
    MISC_FLAG_E_TOUCHING_WADING_BOOTS = 0x0E,
    MISC_FLAG_F_UNKNOWN = 0x0F,
    MISC_FLAG_10_TOUCHING_TURBO_TRAINERS = 0x10,
    MISC_FLAG_11_UNKNOWN = 0x11,
    MISC_FLAG_12_UNKNOWN = 0x12,
    MISC_FLAG_13_UNKNOWN = 0x13,
    MISC_FLAG_14_UNKNOWN = 0x14,
    MISC_FLAG_15_UNKNOWN = 0x15,
    MISC_FLAG_16_UNKNOWN = 0x16,
    MISC_FLAG_17_UNKNOWN = 0x17,
    MISC_FLAG_18_UNKNOWN = 0x18,
    MISC_FLAG_19_UNKNOWN = 0x19,
    MISC_FLAG_1A_UNKNOWN = 0x1A,
