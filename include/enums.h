...
enum actor_e
{
    ...
    ACTOR_2C_TURBO_TALON_TRAINERS = 0x2C,
    ...
    ACTOR_119_MAGIC_CARPET_1 = 0x119,
    ...
    ACTOR_1F5_GV_KAZOOIE_DOOR = 0x1F5,
...
enum asset_e
{
    ...
    // ASSET_E5_ANIM_GRABBA_APPEAR = 0xE5,
    // ASSET_E6_ANIM_GRABBA_IDLE,
    // ASSET_E7_ANIM_GRABBA_HIDE,
    // ASSET_E8_ANIM_GRABBA_DIE,
    ...
    ASSET_1A1_AMIN_SLED = 0x1A1,
    ASSET_1A2_AMIN_NABNUT_SLEEP,
    ...
    ASSET_38A_MODEL_BOGGY_ON_SLED = 0x38A,
...
enum marker_e{
    ...
    MARKER_243_GV_SNS_CHAMBER_DOOR = 0x243
};
